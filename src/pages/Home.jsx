    ...
    return (
        <>
            ...
            <Component>
                <Box>
                    <Box>
                        <Typography><span style={{color:'white'}}>Crack your dream interview today !<br/> Resources from the best</span></Typography>
                        <Button 
                            variant="contained"
                            onClick={() => navigate(routePath.create)}
                        >Post an experience</Button>
                    </Box>
                </Box>       
                <Box>
                    <img src={animatedImage} alt="homeimage" style={{ width: 600, borderRadius:40 }} />
                </Box>
            </Component>
        </>
    )
